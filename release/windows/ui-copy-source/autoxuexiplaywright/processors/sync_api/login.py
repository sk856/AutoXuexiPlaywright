...
from ..common.browser_state import save_browser_state
...
class LoginTask(Task):
    ...
    def __enter__(self) -> Self:
        self._goto(LOGIN_PAGE)
        self.last_page.bring_to_front()
        return self

    def finish(self) -> bool:
        success = False
        if self._wait_locator(self.last_page.locator(LoginSelectors.LOGIN_CHECK).first, _COOKIE_LOGIN_TIMEOUT_MSECS):
            ...
            while (not success) and (failed_login <= RETRY_TIMES):
                ...
                try:
                    ...
                    try:
                        ...
                        save_browser_state(self.last_page)
                        find_event_by_id(
